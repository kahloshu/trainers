    ...
    >
      ...
      <div className="mb-8 flex flex-col items-center gap-3">
        <div
          ...
          style={{ background: "linear-gradient(135deg, var(--accent) 0%, #1a55d4 100%)" }}
        >
        ...
        <div className="text-center">
          <p className="text-[11px] font-semibold tracking-[0.2em] uppercase mb-1" style={{ color: "var(--accent)" }}>
            James Gym
          </p>
      ...
      >
        {step === "phone" ? (
          <>
            ...
            />
            {error && (
              <p className="text-[12px] mb-3" style={{ color: "var(--danger)" }}>{error}</p>
            )}
            <button
              onClick={sendOtp}
          ...
          <>
            ...
            <p className="text-[12.5px] mb-5" style={{ color: "var(--text-muted)" }}>
              <span style={{ color: "var(--text-secondary)" }}>{phone}</span>으로 발송된 6자리 코드를 입력해주세요.
              {trainerName && (
                <span className="block mt-0.5" style={{ color: "var(--accent)" }}>
            ...
            <div className="grid grid-cols-6 gap-2 mb-4" onPaste={handleOtpPaste}>
              {otp.map((v, i) => (
                <input
                  ...
                  style={{
                    background: v ? "var(--accent-subtle-hi)" : "var(--surface-input)",
                    border: `1.5px solid ${v ? "var(--accent)" : "rgba(255,255,255,0.08)"}`,
                    color: "var(--text-primary)",
                  }}
                />
              ))}
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                style={{ color: resendSec > 0 ? "var(--text-muted)" : "var(--accent)" }}
              >
