...
const TRAINERS = [
  ...
  { id:"3", name:"이강훈", specialty:"기능성 트레이닝", career_years:9, short_bio:"운동이 삶의 일부가 될 수 있도록 돕겠습니다.", introduction:"스포츠 과학을 기반으로 한 기능성 트레이닝 전문 트레이너입니다.", certifications:["체육학 학사","CSCS 공인 전문 트레이너","KPTI 기능성 트레이닝 강사","現 제임스짐 소속 9년차"], tags:["근력 향상","재활 트레이닝","체력 증진"], rating_avg:4.8, review_count:41, profile_image:"", featured:false },
  { id:"4", name:"최유진", specialty:"여성 전문 트레이닝", career_years:4, short_bio:"작은 변화가 쌓여 큰 결과를 만듭니다.", introduction:"여성 체형의 특성을 깊이 이해하고 프로그램을 운영합니다.", certifications:["생활스포츠지도사 2급","필라테스 지도자 자격","산전산후 운동 전문 과정 수료","現 제임스짐 소속 4년차"], tags:["다이어트","필라테스","체형 교정"], rating_avg:4.6, review_count:12, profile_image:"", featured:false },
  { id:"5", name:"정동현", specialty:"재활 · 체형 교정", career_years:11, short_bio:"통증 없이, 오래 운동할 수 있는 몸을 만듭니다.", introduction:"스포츠 재활 분야에서 11년을 전문적으로 활동해 온 트레이너입니다.", certifications:["운동처방사 자격","스포츠 재활 전문 과정 수료","병원 연계 재활 트레이닝 5년","現 제임스짐 소속 11년차"], tags:["재활 트레이닝","체형 교정","근력 향상"], rating_avg:5.0, review_count:37, profile_image:"", featured:false },
  { id:"6", name:"한수빈", specialty:"체력 증진 · 다이어트", career_years:3, short_bio:"처음 시작하는 분들을 가장 잘 압니다.", introduction:"운동을 처음 시작하는 분들에게 낯설지 않은 환경과 속도를 제공합니다.", certifications:["생활스포츠지도사 2급","퍼스널 트레이너 전문 과정 수료","現 제임스짐 소속 3년차"], tags:["다이어트","체력 증진"], rating_avg:4.5, review_count:8, profile_image:"", featured:false },
];
